...
namespace TenantAccount.Controllers
{
    ...
    public class ProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var viewData = new Profile();

            try
            {
                var dataContext = await _context.Profiles.FirstOrDefaultAsync(s => s.IdentityUser.Id == userId);

                if(dataContext != null)
                {
                    viewData = dataContext;
                }
            }
            catch (Exception ex) {
            }
        ...
        public async Task<IActionResult> AllProfil()
        {
            var dataContext = await _context.Profiles.Include(s => s.IdentityUser).ToListAsync();
